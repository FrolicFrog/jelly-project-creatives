...
namespace CurvedPathGenerator
{
    ...
    internal class PathFollowerGUI : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(15f);
            Undo.RecordObject(pathFollower, "Modify " + pathFollower.gameObject.name);
            pathFollower.Speed = EditorGUILayout.Slider(pathFollower.Speed, 0, 3500f);
            GUILayout.EndHorizontal();
            GUILayout.Space(5f);
            ...
            GUILayout.Space(15f);
            Undo.RecordObject(pathFollower, "Modify " + pathFollower.gameObject.name);
            pathFollower.EnableCheckFlag = GUILayout.Toggle(pathFollower.EnableCheckFlag, "Enable Check Flag");
            GUILayout.Space(19f);
            Undo.RecordObject(pathFollower, "Modify " + pathFollower.gameObject.name);
